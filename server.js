...
const SERVER_VERSION = "amazon-engine-v6-auto-publish";
...
const data = await shopifyGraphQL(query { publications(first: 20) { edges { node { id name } } } });
...
mutation PublishProduct( $id: ID!, $publicationId: ID! ) { publishablePublish( id: $id, input: { publicationId: $publicationId } ) { publishable { publishedOnCurrentPublication } userErrors { field message } } }, 
{ 
id: productId, 
publicationId 
} 
